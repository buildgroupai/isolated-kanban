...
const dealFlowCardFields = [
  ...
  "lead_score",
  "current_swimlane",
  "company__days_since_last_funding",
  "company__name",
  "company__description",
  "company__company_logo",
  "company__specialities",
  "company__company_id",
  "company__accum_funding_sum",
  "company__country_code",
  "company__is_manual_creation",
  "company__top_speciality",
  "statistics__qualification_checklist_existence",
  "statistics__qualification_checklist_completed",
  "statistics__qualification_checklist_num_of_accepted_metrics",
  "statistics__qualification_checklist_num_of_pending_metrics",
  "statistics__qualification_checklist_num_of_rejected_metrics",
  "statistics__mbm_score_existence",
  "current_swimlane__column_width",
  "current_swimlane__droppable",
  "current_swimlane__excluded_fields_in_card",
  "current_swimlane__included_fields_in_card",
  "current_swimlane__id",
  "current_swimlane__initial_state",
  "current_swimlane__is_system",
  "current_swimlane__max_cards",
  "current_swimlane__name",
  "current_swimlane__num_of_cards",
  "current_swimlane__num_of_cards_alive",
  "current_swimlane__order",
  "current_swimlane__short_name",
  "current_swimlane__show_in_kanban",
  "qualification_checklist__comments_filled",
  "qualification_checklist__next_steps_filled",
  "qualification_checklist__num_of_rejected_metrics",
  "qualification_checklist__score"
];
